                ...
                <div class="login_wrap">
            		<div class="padding_eight_all bg-white">
                       <img src="img/1.jpeg"><br>
                        ...
                        <form action="assets/functionlogin.php" class="was-validated" method="post">
                            <div class="form-group">
                               <label>Enter Email</label>
                                <input type="text" required="" id="email" class="form-control-login " name="email" placeholder="ex: exapme@gmail.com">
                                
                            </div>
                            <div class="form-group">
                               <label>Enter Password</label>
                                <input class="form-control-login" id="password" required="" type="password" name="password" placeholder="Password">
                            </div>
                            <div class="login_footer form-group">
                                <a href="fogetpassword.php">Forgot password?</a>
                            </div>
                            <div class="form-group">
                                <button type="submit" name="btnloginUser" onclick = "return validate() " class=" btn-lg btn-Login btn-block">Login</button>
                            </div>
