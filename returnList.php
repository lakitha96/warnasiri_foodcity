<?php
session_start();
$_SESSION['atPage']="returnList.php";
...
<html lang="en">
   ...
   <body>
      ...
      <section class="account-page section-padding">
                     ...
                     <div class="col-md-4">
                        <div class="card account-left">
                           ...
                           <div class="list-group">
                              ...
                              <a href="returnList.php" class="list-group-item list-group-item-action active"><i aria-hidden="true" class="mdi mdi-keyboard-return"></i> Return Orders</a> 
                        ...
                        <div class="card card-body account-right">
                           <div class="widget">
                              ...
                              <div class="order-list-tabel-main table-responsive">
                                 <table id="tblReturnOrder" class="datatabel table table-striped table-bordered order-list-tabel" width="100%" cellspacing="0">
                                    <thead>
                                       <tr>
       ...
       <div class="modal fade exampleModal" id="returnOrderDetailsDataModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body" id="return_details_view">
     ...
     $(document).ready(function(){  
          $("#tblReturnOrder").on("click", ".btnViewReturnOrder", function(){  
               var return_OrderId = $(this).attr('id'); 
               $.ajax({  
                    url:"viewReturnOrder.php",  
                    method:"post",  
                    data:{return_OrderId:return_OrderId},  
                    success:function(data){  
                       
                        
                         $('#return_details_view').html(data);  
                         $('#returnOrderDetailsDataModal').modal("show");  
                    }  
               });  
          });  
     });  
     ...
     $(document).ready(function(){  
          $("#tblReturnOrder").on("click", ".btnCancelReturn", function(){  
