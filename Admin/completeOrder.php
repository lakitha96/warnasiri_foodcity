<?php
session_start();
$_SESSION['atAdminPage']="completeOrder.php";
...
<!-- Left Sidebar End -->
                       ...
                       <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0 font-size-18">Completed Orders</h4>
                        ...
                        <div class="row">
                            ...
                            <table id="completedOrderTable" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%; ">
                                <thead>
                                    <tr>
                                        <th>Order ID</th>
                                        <th>Customer Name</th>
   ...
   <script>  
     $(document).ready(function(){  
          $("#completedOrderTable").on("click", ".viewOrderDetails", function(){  
