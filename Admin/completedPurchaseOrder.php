...
<!-- Left Sidebar End -->
                       ...
                       <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0 font-size-18">Completed Purchase Orders</h4>

                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">Purchase Orders</a></li>
                                            <li class="breadcrumb-item active">Completed Purchase Orders</li>
                                        </ol>
                                    </div>
                        ...
                        <div class="row">
                            ...
                            <table id="allCompletePurchaseTable" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%; ">
                                <thead>
                                    <tr>
                                         <th>Purchase ID</th>
                                        <th>Supplier</th>
        ...
        <script>
            ...
            $('#allCompletePurchaseTable').DataTable({
                "ordering": false,
                dom: 'Bfrtip',
                 "bStateSave": true,
                ...
                buttons: [
                    {
                        ...
                        title: 'Warnasiri FoodCity Completed Purchase Orders',
                        pageSize: 'A4',
                        exportOptions: {
     ...
     <script>  
     $(document).ready(function(){  
          $("#allCompletePurchaseTable").on("click", ".btnViewPurchaseOrder", function(){  
               var purchase_id = $(this).attr("id");
             $.ajax({  
                    url:"viewComplpetePurchaseOrders.php",  
                    method:"post",  
                    data:{purchase_id:purchase_id,purchaseOrder:'true'},  
     ...
     $(document).ready(function(){
         var purchaseOrder_id = "";
          $("#allCompletePurchaseTable").on("click", ".btnViewGRNOrder", function(){  
             ...
             $.ajax({  
                    url:"viewComplpetePurchaseOrders.php",  
                    method:"post",  
                    data:{purchaseOrder_id:purchaseOrder_id,viewGRN:'true'},  
                    success:function(data){  
