<?php
session_start();
$_SESSION['atAdminPage']="rejectedOrders.php";
...
<!-- Left Sidebar End -->
                       ...
                       <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0 font-size-18">Rejected Orders</h4>
                        ...
                        <div class="row">
                            ...
                            <table id="rejectedOrderTable" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%; ">
                                <thead>
                                    <tr>
                                        <th>Order ID</th>
                                        <th>Customer Name</th>
                ...
                buttons: [
                    {
                        ...
                        title: 'Warnasiri FoodCity Completed Orders',
                        pageSize: 'A4',
                        exportOptions: {
   ...
   <script>  
     $(document).ready(function(){  
          $("#rejectedOrderTable").on("click", ".viewOrderDetails", function(){  
