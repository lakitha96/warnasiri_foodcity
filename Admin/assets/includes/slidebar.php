...
<!--                        <li><a href="advertise-details.php">Advertisements</a></li>-->
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="add-catogory.php">Add Catogory</a></li>
                        <li><a href="all-catogories.php">All Catogories</a></li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        ...
                        <li><a href="all-Products.php">All Products Details</a></li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="customer-details.php">All Customers Details</a></li>
                  ...
                  <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="supplier-register.php">Add Supplier</a></li>
                        <li><a href='supplier-edit.php'>Edit Supplier</a></li>
                        <li><a href='allSuppliers.php'>All Suppliers</a></li>
                    </ul>
                </li>
                   ...
                   <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="addPurchaseOrder.php">Add Purchase Order</a></li>
                        <li><a href='allPurchaseOrders.php'>All Purchase Orders</a></li>
                        <li><a href='completedPurchaseOrder.php'>Completed Purchase Orders</a></li>
                    </ul>
                </li>
                   ...
                   <li>
                    <a href="javascript: void(0);" class="has-arrow waves-effect">
                        ...
                        <span>Purchase Return Order</span>
                    </a>
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="addReturnOrder.php">Return a Purchase Order</a></li>
                        <li><a href='allPurchaseReturnedOrders.php'>All Purchase Returned Orders</a></li>
                        <li><a href='completedReturnPurchasedOrders.php'>Completed Purchase Return Orders</a></li>
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        ...
                        <li><a href="acceptedOrders.php">Accepted Orders</a></li>
                        <li><a href="deliveredOrders.php">Delived Orders</a></li>
                  ...
                  <li>
                    <a href="javascript: void(0);" class="has-arrow waves-effect">
                        ...
                        <span>Sales Return Orders</span>
                    </a>
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="newReturnOrders.php">New Return Orders</a></li>
                        <li><a href="acceptReturnOrder.php">Accepted Return Orders</a></li>
                        <li><a href="deliveredReturnOrders.php">Delived Return Orders</a></li>
                        <li><a href="completeReturnOrders.php">Complete Return Orders</a></li>
                        <li><a href="rejectedReturnOrders.php">Rejected Return Orders</a></li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="allPayments.php">All Payment Details</a></li>
