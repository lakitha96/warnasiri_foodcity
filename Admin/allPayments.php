<?php
session_start();
$_SESSION['atAdminPage']="allPayments.php";
                    ...
                    <div class="container-fluid">
                       ...
                       <div class="row">
                        ...
                        <div class="row">
                            ...
                            <table id="paymentTable" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%; ">
                                <thead>
                                    <tr>
                                        <th>Payment ID</th>
                                        <th>Order ID</th>
                ...
                buttons: [
                    {
                        ...
                        title: 'Warnasiri FoodCity all Payment Records',
                        pageSize: 'A4',
                        exportOptions: {
