<?php
session_start();
$_SESSION['atAdminPage']="acceptedOrders.php";
...
<!-- Left Sidebar End -->
                       ...
                       <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0 font-size-18">Accepted Orders</h4>
                        ...
                        <div class="row">
                            ...
                            <table id="acceptedOrderTable" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%; ">
                                <thead>
                                    <tr>
                                        <th>Order ID</th>
                                        <th>Customer Name</th>
                ...
                buttons: [
                    {
                        ...
                        title: 'Warnasiri FoodCity Deliverd Orders',
                        pageSize: 'A4',
                        exportOptions: {
     ...
     <script>  
     $(document).ready(function(){  
          $("#acceptedOrderTable").on("click", ".deliverdOrder", function(){  
               var order_id = $(this).attr("id");  
              
               $.ajax({  
                    url:"changeOrderStatus.php",  
                    method:"post",  
                    data:{order_id:order_id,ordStatus:'3'},  
                    success:function(data){
                        if(data == "Order status changes to deliverd"){
                        toastr.success(
                              '',
                              data,
                              {
   ...
   <script>  
     $(document).ready(function(){  
          $("#acceptedOrderTable").on("click", ".viewOrderDetails", function(){  
