<?php
session_start();
$_SESSION['atAdminPage']="newOrder.php";
...
<!-- Left Sidebar End -->
                       ...
                       <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0 font-size-18">Rejected Return Orders</h4>

                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">Return Orders</a></li>
                                            <li class="breadcrumb-item active">Rejected Return Orders</li>
                                        </ol>
                                    </div>
                        ...
                        <div class="row">
                            ...
                            <table id="rejectedReturnOrderTable" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%; ">
                                <thead>
                                    <tr>
        ...
        <script>
            ...
            $('#rejectedReturnOrderTable').DataTable( {
                "ordering": false,
                dom: 'Bfrtip',
                 "bStateSave": true,
                ...
                buttons: [
                    {
                        ...
                        title: 'Warnasiri FoodCity Rejected Return Orders',
                        pageSize: 'A4',
                        exportOptions: {
                        columns: [0,1,2,3,4,5]
   ...
   <script>  
     $(document).ready(function(){  
          $("#rejectedReturnOrderTable").on("click", ".viewReturnOrderDetails", function(){  
