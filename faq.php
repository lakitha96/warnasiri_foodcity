         ...
         <div class="container">
            <div class="row">
               <div class="col-lg-3 col-md-3">
                  <h4 class="mb-5 mt-0"><a class="logo" href="index.php"><img src="img/Daya.png">  </a></h4>
                  ...
                  <p class="mb-0"><a class="text-primary" href="#"><i class="mdi mdi-web"></i> www.dayastore.com</a></p>
               </div>
