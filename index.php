   ...
   <body>
     ...
     echo "<script>alert('test');</script>";
      ...
      <section class="product-items-slider section-padding">
         <div class="container">
            <div class="section-header">
               <h5 class="heading-design-h5">Grocery <span class="badge badge-primary">New StockcAvailable</span>
                  <a class="float-right text-secondary" href="shop.php?product_catogory=Grocery">View All</a>
               </h5>
            </div>
      ...
      <section class="product-items-slider section-padding">
         <div class="container">
            <div class="section-header">
               <h5 class="heading-design-h5">Beverages <span class="badge badge-primary">New Stock Available</span>
                  <a class="float-right text-secondary" href="shop.php?product_catogory=Beverages">View All</a>
               </h5>
            </div>
            <div class="owl-carousel owl-carousel-featured">
               <?php
      ...
      <section class="product-items-slider section-padding">
         <div class="container">
            <div class="section-header">
               <h5 class="heading-design-h5">Household <span class="badge badge-primary">New Stock Available</span>
                  <a class="float-right text-secondary" href="shop.php?product_catogory=Household">View All</a>
               </h5>
            </div>
            <div class="owl-carousel owl-carousel-featured">
               <?php
      ...
      <section class="product-items-slider section-padding">
         <div class="container">
            <div class="section-header">
               <h5 class="heading-design-h5">Homeware <span class="badge badge-primary">New Stock Availables</span>
                  <a class="float-right text-secondary" href="shop.php?product_catogory=Homeware">View All</a>
               </h5>
            </div>
            <div class="owl-carousel owl-carousel-featured">
               <?php
